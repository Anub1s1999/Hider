...
def encode(img_file,secret_file):
    ...
    '''
    #secret_file=str(input("Enter the Excutable/Text/Script path: "))
    ...
    im.save('stegoimage2.png')
    print('Done, "stegoimage2.png" should be in your directory')

# use example
#encode('hills s.jpg', 'script.py'